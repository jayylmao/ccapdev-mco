import { logInUser, saveUserListToStorage } from "./create-user.js";

const storedPosts = JSON.parse(localStorage.getItem(logInUser.getUsername()))?.userPosts;
...
if (!storedPosts || storedPosts.length === 0) {
    ...
    console.log('create-post.js executed');
